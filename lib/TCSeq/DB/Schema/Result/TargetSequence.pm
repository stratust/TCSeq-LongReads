use utf8;
package TCSeq::DB::Schema::Result::TargetSequence;
...
=head1 TABLE: C<target_sequence>

=cut

__PACKAGE__->table("target_sequence");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:paxJaEu99QcXuZDmRy507w
