use utf8;
package TCSeq::DB::Schema::Result::BaitSequence;
...
=head1 TABLE: C<bait_sequence>

=cut

__PACKAGE__->table("bait_sequence");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:FF4zLZbNqtgPmMZDEUoA7g
