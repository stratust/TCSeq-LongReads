use utf8;
package TCSeq::DB::Schema::Result::InsertionDefinedHasSeq;
...
=head1 TABLE: C<insertion_defined_has_seq>

=cut

__PACKAGE__->table("insertion_defined_has_seq");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:0FS/vIIuqQc+Y7Jy25jhaw
